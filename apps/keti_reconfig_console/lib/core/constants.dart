...
const List<LabelHotspotConfig> labelHotspots = [
  LabelHotspotConfig(
    ...
    label: 'TSN-F A',
    position: '3.4m 8m 13m',
    dataTarget: '3.4m 4m 13m',
  ...
  LabelHotspotConfig(
    slotName: 'rearSwitch',
    label: 'TSN-R',
    position: '0m 7.5m -13m',
    dataTarget: '0m 4m -13m',
    dataOrbit: '135deg 45deg 2.5m',
  ),
  LabelHotspotConfig(
...
const Map<String, List<String>> alertMaterialGroups = {
  'Path1Route': [
    ...
    'Path1',
    'Path1-line', // the single bridging line added to the model (healthy blue -> red on fault)
